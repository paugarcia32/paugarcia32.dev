---
title: "EETAC GO"
description: "Flutter app for campus exploration with QR challenges, chat, and gamification."
date: "Jun 29, 2023"
...
<FeatureGrid
  columns={3}
  items={[
    { icon: "viewfinder-circle", title: "Campus Map", description: "Interactive map with live location, itineraries, and challenges displayed on top." },
    { icon: "document", title: "QR Challenges", description: "Complete activities by finding hidden QR codes at physical locations on campus." },
    { icon: "signal", title: "Community Chat", description: "Each challenge has its own global chat room to connect with other participants." },
    { icon: "magnifying-glass", title: "Discover", description: "Browse all active accounts, filter by name, and follow or unfollow users." },
    { icon: "bolt", title: "Badges & Levels", description: "Earn badges and level up by completing routes, adding a gamification layer." },
    { icon: "tv", title: "Multilingual", description: "Available in Spanish, Catalan, English, and Chinese, with dark and light mode." },
  ]}
/>
